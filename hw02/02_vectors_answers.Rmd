...
names(roulette_vector) <- c("Monday", "Tuesday", "Wednesday", "Thurday", "Friday")
...
poker_vector <- c(days_vector)
roulette_vector <- c(days_vector)
...
'total_daily' <- c(116, -100, 120, -470, 250)
...
# Check if you realized higher total gains in poker than in roulet
...
# Define a new variable based on a selection
roulette_selections_vector <- c(roulette_vector[2:5])
...
poker_start <- c(poker_vector[1:3])
